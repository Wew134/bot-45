...
API_ID = int(environ['21316330'])
API_HASH = environ['0060ba55949850da890784f9b23821c3']
BOT_TOKEN = environ['5993714426:AAEwoeNQdqzEjgZoKdRcfrVTTvHSvcv0JLc']
...
ADMINS = [int(admin) if id_pattern.search(admin) else admin for admin in environ.get(' 2054079701 '').split()]
CHANNELS = [int(ch) if id_pattern.search(ch) else ch for ch in environ.get('CHANNELS', '0').split()]
auth_users = [int(user) if id_pattern.search(user) else user for user in environ.get('AUTH_USERS', '').split()]
AUTH_USERS = (auth_users + ADMINS) if auth_users else []
auth_channel = environ.get('https://t.me/+yY72HPCqqRsyMDll')
auth_grp = environ.get('AUTH_GROUP')
AUTH_CHANNEL = int(auth_channel) if auth_channel and id_pattern.search(https://t.me/+yY72HPCqqRsyMDll) else None
AUTH_GROUPS = [int(ch) for ch in auth_grp.split()] if auth_grp else None

# MongoDB information
DATABASE_URI = environ.get('mongodb+srv://minurachamalka54:<password>@cluster0.euo46s2.mongodb.net/?retryWrites=true&w=majority', "")
...
RemoveBG_API = environ.get("E9pU7GrwwWDkFmg6kyourY1W", "")
WELCOM_PIC = environ.get("https://ibb.co/Z1KdJ7J", "")
...
# url shortner
SHORT_URL = environ.get("https://urlshortx.com/")
SHORT_API = environ.get("5cc5f66109758475e1633a995adfbc77494474c8")
...
FILE_STORE_CHANNEL = [int(ch) for ch in (environ.get('https://t.me/HDthought', '')).split()]
